        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                    <strong style="color:#c28565;">Microneedling</strong> is a minimally invasive treatment that uses fine
                    needles to create controlled micro-injuries in the skin. This stimulates the body’s natural healing
                    response, boosting collagen and elastin production for smoother, firmer, and younger-looking skin.
                </p>
                ...
                <div class="row g-4">
                        ...
                        <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                            <div class="card-body">
                                ...
                                <p class="card-text" style="color:#666; line-height:1.7;">
                                    Encourages the skin to repair itself naturally by producing fresh collagen and elastin.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                            <div class="card-body">
                                <h5 class="fw-bold mb-3" style="color:#c28565; font-size:1.4rem;">
                                    <i class="fas fa-star me-2" style="color:#c28565;"></i>Benefits of Microneedling
                                </h5>
                                <ul class="list-unstyled mb-0"
                                    style="font-size:0.95rem; color:#444; line-height:2;">
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Reduces acne & surgical scars</li>
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Minimizes fine lines & wrinkles</li>
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Improves skin elasticity</li>
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Enhances absorption of serums</li>
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Safe with minimal downtime</li>
                                </ul>
                            </div>
                        </div>
                    </div>
