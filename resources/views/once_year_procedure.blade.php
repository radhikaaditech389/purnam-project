            ...
            <div class="breadcumb-content">
                ...
                <div class="breadcumb-menu-wrapper">
                    <ul class="breadcumb-menu">
                        <li><a href="/">Home</a></li>
                        <li>About Once-a-year Procedure</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0 position-relative">
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/once_year_img2.jpg') }}" alt="Once-a-year Procedure"
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/once_year_img.jpg') }}" alt="Long-lasting Skin Results"
                ...
                <div class="col-lg-6">
                    ...
                    <h2 class="fw-bold mb-4"
                        ...
                        Once-a-year Procedure: Minimal Effort, Maximum Impact
                    </h2>

                    <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                        Our <strong style="color:#c28565;">Once-a-year Procedure</strong> is designed for those who
                        want
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text" style="color:#666; line-height:1.7;">
                                        Effective treatment designed to give year-long results with just a single
                                        session.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text" style="color:#666; line-height:1.7;">
                                        Non-invasive, clinically tested, and designed for sustainable, natural-looking
                                        results.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Year-long
                                            rejuvenation</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Minimal clinic
                                            visits</li>
