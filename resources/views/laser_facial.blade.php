...
<body>
    ...
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/laser_facial_bg.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">About Laser Facial</h2>
                <div class="breadcumb-menu-wrapper">
                    <ul class="breadcumb-menu">
                        <li><a href="/">Home</a></li>
                        <li>About Laser Facial</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                        Transform your skin with the <strong style="color:#c28565;">Laser Facial</strong> — a powerful
                        treatment that targets pigmentation, acne scars, fine lines, and dullness for a flawless
                        complexion.
                    </p>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Boosts collagen
                                            for youthful skin</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Shrinks pores &
                                            evens skin tone</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Gives instant
                                            radiance & glow</li>
                                    </ul>
                                </div>
                            </div>
