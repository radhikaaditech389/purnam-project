            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0 position-relative">
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/lift_tighten_skin1.jpg') }}" alt="Lift & Tighten Skin Treatment"
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/lift_tighten_skin2.jpg') }}" alt="Firm & Tightened Skin"
                ...
                <div class="col-lg-6">
                    ...
                    <h2 class="fw-bold mb-4"
                        ...
                        Lift & Tighten: Restore Youthful Firmness
                    </h2>

                    <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                        Our <strong style="color:#c28565;">Lift & Tighten Skin Therapy</strong> naturally stimulates
                        collagen,
                        improves elasticity, and redefines facial contours — giving you a firmer, lifted, and
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-12">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#c28565; font-size:1.4rem;">
                                        <i class="fas fa-star me-2" style="color:#c28565;"></i>Benefits of Lift &
                                        Tighten
                                    </h5>
                                    <ul class="list-unstyled mb-0"
                                        style="font-size:0.95rem; color:#444; line-height:2;">
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Firms sagging skin
                                        </li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Redefines jawline
                                            & contours</li>
