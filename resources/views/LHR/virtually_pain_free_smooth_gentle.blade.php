            ...
            <div class="breadcumb-content">
                ...
                <div class="breadcumb-menu-wrapper">
                    <ul class="breadcumb-menu">
                        ...
                        <li>Virtually Pain-Free, Smooth and Gentle</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0 position-relative">
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/treatment-images/laser_hair_removal.jpg') }}"
                                alt="Laser Hair Removal" class="main-img rounded-4 shadow"
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/treatment-images/laser_hair_removal2.jpeg') }}"
                                alt="Pain-Free Hair Removal" class="overlay-img rounded-4 shadow"
                ...
                <div class="col-lg-6">
                    <span class="text-uppercase fw-semibold mb-2 d-block"
                        ...
                        Smooth Skin with Zero Hassle
                    </span>
                    <h2 class="fw-bold mb-4"
                        style="font-size:3.2rem; color:#333; letter-spacing: -1.5px; line-height:1.2;">
                        Virtually Pain-Free, Smooth and Gentle
                    </h2>

                    <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                        Unwanted hair can be frustrating and time-consuming to manage. At
                        <strong style="color:#a07855;">our clinic</strong>, we provide advanced
                        <strong>laser hair removal</strong> treatments that are smooth, gentle, and virtually pain-free
                        —
                        giving you silky, hair-free skin with long-lasting results.
                    </p>
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background: #fff; border-radius: 10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855; font-size:1.4rem;">
                                        <i class="fas fa-info-circle me-2" style="color:#a07855;"></i>Concerns
                                    </h5>
                                    <ul class="list-unstyled mb-0"
                                        style="font-size:0.95rem; color:#444; line-height:2;">
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Unwanted
                                            facial & body hair</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Frequent
                                            waxing/shaving</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Skin
                                            irritation from hair removal creams</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Ingrown
                                            hairs</li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background: #fff; border-radius: 10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        style="font-size:0.95rem; color:#444; line-height:2;">
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Genetics &
                                            hormonal changes</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Polycystic
                                            ovarian syndrome (PCOS)</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Stress &
                                            lifestyle factors</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Temporary
                                            methods causing regrowth</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background: #fff; border-radius: 10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        style="font-size:0.95rem; color:#444; line-height:2;">
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Pain-free
                                            laser technology</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Suitable
                                            for all skin types</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Precision
                                            targeting of hair follicles</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Minimal
                                            downtime & lasting results</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Experienced
                                            dermatologists & laser specialists</li>
                                        <li><i class="fas fa-check-circle me-2"
                                                style="color:#a07855;"></i>FDA-approved technology</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Customized
                                            treatment plans</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Safe,
                                            gentle & long-lasting results</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
