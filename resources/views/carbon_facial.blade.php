            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                        Discover the power of the <strong style="color:#c28565;">Carbon Facial</strong> — a safe,
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#c28565; font-size:1.4rem;">
                                        <i class="fas fa-lightbulb me-2" style="color:#c28565;"></i>Instant
                                        Brightening
                                    </h5>
                                    <p class="card-text" style="color:#666; line-height:1.7;">
                                        Laser energy stimulates collagen and removes dead cells for a brighter
                                        complexion.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Removes dirt, oil
                                            & impurities</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Controls acne &
                                            tightens pores</li>
