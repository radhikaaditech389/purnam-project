            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                        <strong style="color:#c28565;">Laser Toning</strong> is a safe and effective treatment that
                        uses Q-switched Nd:YAG laser technology
                        to target deep pigmentation, melasma, and uneven skin tone. It rejuvenates the skin, giving a
                        smoother,
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-12">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#c28565; font-size:1.4rem;">
                                        <i class="fas fa-star me-2" style="color:#c28565;"></i>Benefits of Laser
                                        Toning
                                    </h5>
                                    <ul class="list-unstyled mb-0"
                                        style="font-size:0.95rem; color:#444; line-height:2;">
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Reduces
                                            pigmentation & dark spots</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Effective for
                                            melasma & uneven skin tone</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Tightens pores &
                                            improves texture</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Non-invasive &
                                            painless treatment</li>
