    ...
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/img/breadcumb/breadcumb-bg.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">Scar Revision</h2>
            ...
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-6 text-center position-relative">
                    <div class="image-stack position-relative d-inline-block p-3"
                        ...
                        <img src="{{ asset('purnam/hair-treatment1.jpg') }}" alt="Scar Revision Dermatosurgery"
                        ...
                        <img src="{{ asset('purnam/hair-treatment2.jpg') }}" alt="Advanced Scar Treatment"
                ...
                <div class="col-lg-6">
                    ...
                    <h2 class="fw-bold mb-4"
                        ...
                        Scar Revision – Dermatosurgery
                    </h2>

                    <p class="mb-4 lead" style="color:#555; font-size:1.1rem; line-height:1.8;">
                        Scars from acne, injury, surgery, or burns can impact confidence and skin appearance.
                        <strong style="color:#a07855;">Scar Revision through Dermatosurgery</strong> uses
                        advanced medical techniques to reduce visible scars, restore smoother skin texture,
                        and improve overall aesthetics. At our clinic, procedures are performed by
                        <strong>expert dermatologists</strong> to ensure safe and natural-looking results.
                    </p>
                    ...
                    <div class="row g-4">
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855;">
                                        <i class="fas fa-tools me-2"></i>Scar Revision Methods
                                    </h5>
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Laser resurfacing
                                            for smoother skin</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Surgical excision
                                            for deep scars</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Microneedling &
                                            PRP therapy</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Chemical peels for
                                            mild scars</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Dermal fillers for
                                            depressed scars</li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855;">
                                        <i class="fas fa-heart me-2"></i>Benefits of Dermatosurgery
                                    </h5>
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Minimizes scar
                                            visibility</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Improves skin
                                            smoothness & tone</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Boosts
                                            self-confidence</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Safe, customized
                                            procedures</li>
