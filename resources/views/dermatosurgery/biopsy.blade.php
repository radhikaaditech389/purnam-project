    ...
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/img/breadcumb/breadcumb-bg.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">Biopsy</h2>
            ...
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-6 text-center position-relative">
                    <div class="image-stack position-relative d-inline-block p-3"
                        ...
                        <img src="{{ asset('purnam/hair-treatment1.jpg') }}" alt="Skin Biopsy Procedure"
                        ...
                        <img src="{{ asset('purnam/hair-treatment2.jpg') }}" alt="Dermatosurgery Biopsy"
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4 lead" style="color:#555; font-size:1.1rem; line-height:1.8;">
                        A <strong style="color:#a07855;">skin biopsy</strong> is a minor surgical procedure in which a
                        small
                        sample of skin is removed and examined under a microscope. It is a crucial diagnostic tool that
                        helps
                        dermatologists confirm conditions such as <em>skin cancers, infections, chronic skin disorders,
                            or
                            unexplained growths</em>. Performed with local anesthesia, a biopsy is safe, quick, and
                        provides
                    ...
                    <div class="row g-4">
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855;">
                                        <i class="fas fa-tools me-2"></i>Types of Biopsy
                                    </h5>
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>
                                            <strong>Punch Biopsy</strong> – circular blade removes a small skin core
                                        </li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>
                                            <strong>Excisional Biopsy</strong> – entire lesion/growth is removed
                                        </li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>
                                            <strong>Incisional Biopsy</strong> – part of a larger lesion is sampled
                                        </li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>
                                            <strong>Shave Biopsy</strong> – surface layer of abnormal skin is shaved off
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855;">
                                        <i class="fas fa-heart me-2"></i>Why Biopsy is Important
                                    </h5>
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Early detection of
                                            skin cancers</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Accurate diagnosis
                                            of chronic skin conditions</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Guides effective
                                            treatment planning</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Quick, safe, and
                                            outpatient procedure</li>
                    ...
                    <div class="mt-4">
                        <div class="card border-0 shadow-sm" style="background:#fff; border-radius:10px;">
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                    <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Keep the biopsy site
                                        clean & covered</li>
                                    <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Apply prescribed
                                        ointment to aid healing</li>
                                    <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Avoid scratching or
                                        rubbing the area</li>
                                    <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Watch for signs of
                                        infection (redness, swelling)</li>
                                    <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Follow up for biopsy
                                        report & treatment guidance</li>
                                </ul>
                            </div>
                        </div>
                    </div>
