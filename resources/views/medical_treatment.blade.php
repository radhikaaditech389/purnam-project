                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#c28565; font-size:1.4rem;">
                                        <i class="fas fa-stethoscope me-2" style="color:#c28565;"></i>Advanced
                                        Therapies
                                    </h5>
                                    <p class="card-text" style="color:#666; line-height:1.7;">
                                        Utilization of clinically proven techniques & technologies for effective
                                        outcomes.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#c28565; font-size:1.4rem;">
                                        <i class="fas fa-heartbeat me-2" style="color:#c28565;"></i>Benefits of
                                        Medical Treatment
                                    </h5>
                                    <ul class="list-unstyled mb-0"
                                        style="font-size:0.95rem; color:#444; line-height:2;">
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Safe &
                                            dermatologist-supervised procedures</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Effective for
                                            chronic & complex skin issues</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Customized plans
                                            for each patient</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Combines medical
                                            science & cosmetic care</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Improves long-term
                                            skin health</li>
                                    </ul>
                                </div>
                            </div>
