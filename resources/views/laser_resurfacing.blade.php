...
<body>
    ...
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/laser_resurfacing_bg.jpg') }}">
        <div class="container">
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Improves acne
                                            scars
                                            & pigmentation</li>
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Restores youthful
                                            glow</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Long-lasting
                                            results
