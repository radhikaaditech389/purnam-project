...
==============================-->
    ...
    Breadcumb
============================== -->
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/microdermation-bg.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">About Microdermabrasion</h2>
                <div class="breadcumb-menu-wrapper">
                    <ul class="breadcumb-menu">
                        <li><a href="/">Home</a></li>
                        <li>About Microdermabrasion</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <!--==============================
Microdermabrasion Procedure Section
==============================-->
    <section class="microdermabrasion-section py-5 skin-section-bg">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0 position-relative">
                    ...
                    <div class="col-lg-12 position-relative mb-4">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/microderma.jpg') }}"
                                alt="Microdermabrasion Treatment Before" class="main-img rounded-4 shadow"
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/microderma1.jpg') }}" alt="Microdermabrasion After"
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                        <strong style="color:#c28565;">Microdermabrasion</strong> is a safe, non-invasive procedure that
                        gently
                        exfoliates the outer layer of dead skin cells using fine crystals or a diamond tip device. It
                        helps improve
                        skin tone, reduce mild scars, and restore a smoother, brighter complexion with no downtime.
                    </p>
                    ...
                    <div class="row g-4">
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#c28565; font-size:1.4rem;">
                                        <i class="fas fa-leaf me-2" style="color:#c28565;"></i>Exfoliation
                                    </h5>
                                    <p class="card-text" style="color:#666; line-height:1.7;">
                                        Removes dead skin cells and unclogs pores, giving your skin a fresh, smooth
                                        feel.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#c28565; font-size:1.4rem;">
                                        <i class="fas fa-sync me-2" style="color:#c28565;"></i>Skin Renewal
                                    </h5>
                                    <p class="card-text" style="color:#666; line-height:1.7;">
                                        Stimulates new cell growth and improves overall skin texture and brightness.
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Improves skin tone &
                                            texture</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Reduces mild acne
                                            scars & blemishes</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Unclogs pores &
                                            reduces blackheads</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Boosts collagen
                                            production</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Safe & quick with no
                                            downtime</li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="mt-4">
                        <a href="/appointment" class="btn px-4 py-3"
                            ...
                            Book Your Microdermabrasion Now
                        </a>
                    </div>
                </div>
            </div>
