            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                        Our <strong style="color:#c28565;">Wrinkle Treatments</strong> are designed to target fine
                        lines and
                    ...
                    <div class="row g-4">
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text" style="color:#666; line-height:1.7;">
                                        Targeted treatments to smooth fine lines and expression wrinkles for natural
                                        results.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text" style="color:#666; line-height:1.7;">
                                        Non-invasive methods that deliver fast improvements with results lasting for
                                        months.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#c28565; font-size:1.4rem;">
                                        <i class="fas fa-star me-2" style="color:#c28565;"></i>Benefits of Wrinkle
                                        Treatments
                                    </h5>
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Restores youthful
                                            glow</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Minimal downtime
                                        </li>
                                    </ul>
                                </div>
                            </div>
