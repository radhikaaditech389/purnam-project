            ...
            <div class="breadcumb-content">
                ...
                <div class="breadcumb-menu-wrapper">
                    <ul class="breadcumb-menu">
                        <li><a href="/">Home</a></li>
                        <li>About wrinkle_treatments</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 mb-4 mb-lg-0 position-relative">
                ...
                <div class="col-lg-12 position-relative mb-4">
                    <div class="image-wrapper position-relative">
                        <img src="{{ asset('purnam/Wrinkle_treatments.jpg') }}" alt="Wrinkle Treatment"
                ...
                <div class="col-lg-12 position-relative">
                    <div class="image-wrapper position-relative">
                        <img src="{{ asset('purnam/anti_wrinkle2.jpg') }}" alt="Wrinkle Reduction"
            ...
            <div class="col-lg-6">
                ...
                <h2 class="fw-bold mb-4"
                    ...
                    Wrinkle Treatments for Smooth Skin
                </h2>
