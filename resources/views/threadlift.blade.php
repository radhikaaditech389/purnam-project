            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0 position-relative">
                    ...
                    <div class="col-lg-12 position-relative mb-4">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/threadlift2.jpg') }}" alt="Thread Lift Treatment"
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/threadlift3.jpg') }}" alt="Non-Surgical Thread Lift"
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                        A <strong style="color:#c28565;">Thread Lift</strong> is a minimally invasive procedure that
                        uses
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Non-surgical
                                            facelift with minimal downtime</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Instant lifting
                                            and tightening effect</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Boosts collagen
                                            for long-lasting results</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Natural, refreshed
                                            appearance</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Safe, quick &
