...
==============================-->
    ...
    Breadcumb
============================== -->
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/collegian_treatment_bg.jpg') }}">
        <div class="container">
...
==============================-->
    <section class="collagen-section py-5 skin-section-bg">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                        Our <strong style="color:#c28565;">Collagen Stimulation Therapy</strong> enhances your skin’s
                        natural
                    ...
                    <div class="row g-4">
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#c28565; font-size:1.4rem;">
                                        <i class="fas fa-seedling me-2" style="color:#c28565;"></i>Boost Elasticity
                                    </h5>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#c28565; font-size:1.4rem;">
                                        <i class="fas fa-gem me-2" style="color:#c28565;"></i>Plump & Smooth
                                    </h5>
                                    <p class="card-text" style="color:#666; line-height:1.7;">
                        ...
                        <div class="col-md-12">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#c28565; font-size:1.4rem;">
                                        <i class="fas fa-heart me-2" style="color:#c28565;"></i>Benefits of Collagen
                                        Stimulation
                                    </h5>
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Safe & effective for
                                            all skin types</li>
                                    </ul>
                                </div>
                            </div>
