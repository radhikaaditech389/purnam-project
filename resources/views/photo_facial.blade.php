...
<body>
    ...
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/photo_facial_bg.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">About Photo Facial</h2>
                <div class="breadcumb-menu-wrapper">
                    <ul class="breadcumb-menu">
                        <li><a href="/">Home</a></li>
                        <li>About Photo Facial</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0 position-relative">
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/photo_facial2.jpg') }}" alt="PhotoFacial Treatment"
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/photo_facial.jpg') }}" alt="PhotoFacial Skin Glow"
                ...
                <div class="col-lg-6">
                    ...
                    <h2 class="fw-bold mb-4"
                        ...
                        PhotoFacial: Restore Radiance & Clarity
                    </h2>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Reduces sun damage
                                            &
                                            pigmentation</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Evens out skin
                                            tone
                                        </li>
