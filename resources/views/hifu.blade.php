...
<body>
    ...
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/hifu-bg.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">About High Intensity Focused Ultrasound</h2>
                <div class="breadcumb-menu-wrapper">
                    <ul class="breadcumb-menu">
                        <li><a href="/">Home</a></li>
                        <li>About High Intensity Focused Ultrasound</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0 position-relative">
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/hifu1.jpg') }}" alt="HIFU Treatment"
                ...
                <div class="col-lg-6">
                    ...
                    <h2 class="fw-bold mb-4"
                        ...
                        HIFU: Non-Surgical Face Lift & Rejuvenation
                    </h2>

                    <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                        Discover the power of <strong style="color:#c28565;">High Intensity Focused Ultrasound
                            (HIFU)</strong> —
                        a cutting-edge treatment that uses ultrasound energy to stimulate collagen, tighten skin, and
                        give you a youthful, lifted look without surgery.
                    </p>
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Non-surgical
                                            facelift</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Tightens loose
                                            skin</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Stimulates natural
                                            collagen</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Improves jawline &
                                            contour</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>No downtime, safe
                                            & effective</li>
                                    </ul>
                                </div>
                            </div>
