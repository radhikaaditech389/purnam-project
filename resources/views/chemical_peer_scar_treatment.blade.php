            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                        <strong style="color:#c28565;">Chemical Peeling</strong> is a safe and effective procedure for
                        reducing
                        acne scars, pigmentation, and uneven skin texture. By applying controlled chemical solutions, it
                        exfoliates
                        the outer skin layers, stimulating new cell growth and revealing smoother, healthier skin
                        beneath.
                    </p>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-12">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#c28565; font-size:1.4rem;">
                                        <i class="fas fa-star me-2" style="color:#c28565;"></i>Benefits of Chemical
                                        Peeling Scar Treatment
                                    </h5>
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Improves skin tone
                                            & texture</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Stimulates
                                            collagen production</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Reveals fresher,
                                            glowing skin</li>
                                        <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Safe & effective
                                            cosmetic procedure</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
