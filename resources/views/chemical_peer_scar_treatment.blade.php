...
==============================-->
    ...
    Breadcumb
============================== -->
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/chemical-peering-new-bg.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">About Chemical Peeling Scar Treatment</h2>
                <div class="breadcumb-menu-wrapper">
                    <ul class="breadcumb-menu">
                        <li><a href="/">Home</a></li>
                        <li>About Chemical Peeling Scar Treatment</li>
                    </ul>
                </div>
            </div>
        </div>
   ...
   <!--==============================
Chemical Peeling Scar Treatment Procedure Section
==============================-->
<section class="chemical-peeling-scar-treatment-section py-5 skin-section-bg">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 mb-4 mb-lg-0 position-relative">
                ...
                <div class="col-lg-12 position-relative mb-4">
                    <div class="image-wrapper position-relative">
                        <img src="{{ asset('purnam/chemical_peer3.jpg') }}" alt="Chemical Peeling Before"
                        ...
                        <div class="circle-badge"
                            ...
                            Chemical Peeling Scar Treatment
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12 position-relative">
                    <div class="image-wrapper position-relative">
                        <img src="{{ asset('purnam/chemical_peer4.jpg') }}" alt="Chemical Peeling After"
            ...
            <div class="col-lg-6">
                ...
                <h2 class="fw-bold mb-4"
                    ...
                    Chemical Peeling Scar Treatment Procedure
                </h2>

                <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                    <strong style="color:#c28565;">Chemical Peeling</strong> is a safe and effective procedure for reducing
                    acne scars, pigmentation, and uneven skin texture. By applying controlled chemical solutions, it exfoliates
                    the outer skin layers, stimulating new cell growth and revealing smoother, healthier skin beneath.
                </p>
                ...
                <div class="row g-4">
                        ...
                        <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                            <div class="card-body">
                                <h5 class="fw-bold mb-3" style="color:#c28565; font-size:1.4rem;">
                                    <i class="fas fa-magic me-2" style="color:#c28565;"></i>Scar Fading
                                </h5>
                                <p class="card-text" style="color:#666; line-height:1.7;">
                                    Gradually lightens and reduces the appearance of acne scars and blemishes.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                            <div class="card-body">
                                <h5 class="fw-bold mb-3" style="color:#c28565; font-size:1.4rem;">
                                    <i class="fas fa-sync-alt me-2" style="color:#c28565;"></i>Skin Renewal
                                </h5>
                                <p class="card-text" style="color:#666; line-height:1.7;">
                                    Promotes cell regeneration for smoother, fresher, and rejuvenated skin.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                            <div class="card-body">
                                <h5 class="fw-bold mb-3" style="color:#c28565; font-size:1.4rem;">
                                    <i class="fas fa-star me-2" style="color:#c28565;"></i>Benefits of Chemical Peeling Scar Treatment
                                </h5>
                                <ul class="list-unstyled mb-0"
                                    style="font-size:0.95rem; color:#444; line-height:2;">
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Reduces acne scars & pigmentation</li>
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Improves skin tone & texture</li>
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Stimulates collagen production</li>
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Reveals fresher, glowing skin</li>
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Safe & effective cosmetic procedure</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-4">
                    <a href="/appointment" class="btn px-4 py-3"
                        ...
                        Book Your Chemical Peeling Treatment Now
                    </a>
                </div>
            </div>
        </div>
