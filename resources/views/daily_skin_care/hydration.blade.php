    ...
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/img/breadcumb/breadcumb-bg.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">Hydration</h2>
            ...
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-6 text-center position-relative">
                    <div class="image-stack position-relative d-inline-block p-3"
                        ...
                        <img src="{{ asset('purnam/hair-treatment1.jpg') }}" alt="Hydration Daily Skin Care"
                        ...
                        <img src="{{ asset('purnam/hair-treatment2.jpg') }}" alt="Moisturizing Skin Routine"
                ...
                <div class="col-lg-6">
                    ...
                    <h2 class="fw-bold mb-4"
                        ...
                        Hydration – Daily Skin Care
                    </h2>

                    <p class="mb-4 lead" style="color:#555; font-size:1.1rem; line-height:1.8;">
                        Hydrated skin is the foundation of a glowing, youthful complexion.
                        Our <strong>Daily Hydration Skin Care</strong> program focuses on maintaining the skin’s natural
                        moisture barrier, preventing dryness, dullness, and early signs of aging.
                        With the right cleansers, moisturizers, and hydrating serums, your skin stays soft, supple, and
                        radiant.
                    </p>
                    ...
                    <div class="row g-4">
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855;">
                                        <i class="fas fa-tint me-2"></i>Daily Hydration Steps
                                    </h5>
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Gentle Cleansing
                                            without over-drying</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Hydrating Toners &
                                            Serums</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Moisturizers with
                                            Hyaluronic Acid</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Daily Sunscreen
                                            Protection</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Night Cream for
                                            Repair & Nourishment</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855;">
                                        <i class="fas fa-star me-2"></i>Benefits of Hydrated Skin
                                    </h5>
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Soft, plump,
                                            youthful skin</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Improved skin
                                            texture & elasticity</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Prevents premature
                                            fine lines</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Natural glow &
                                            radiance</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Stronger skin
