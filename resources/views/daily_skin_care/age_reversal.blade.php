    ...
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/img/breadcumb/breadcumb-bg.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">Age Reversal</h2>
            ...
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-6 text-center position-relative">
                    <div class="image-stack position-relative d-inline-block p-3"
                        ...
                        <img src="{{ asset('purnam/hair-treatment1.jpg') }}" alt="Age Reversal Treatment"
                        ...
                        <img src="{{ asset('purnam/hair-treatment2.jpg') }}" alt="Anti-Aging Skin Care"
                ...
                <div class="col-lg-6">
                    ...
                    <h2 class="fw-bold mb-4"
                        ...
                        Age Reversal – Restore Youthful Radiance
                    </h2>

                    <p class="mb-4 lead" style="color:#555; font-size:1.1rem; line-height:1.8;">
                        Aging is natural, but premature fine lines, wrinkles, and loss of firmness can make you look
                        older than you feel. At <strong style="color:#a07855;">Purnam</strong>,
                        our <strong>Age Reversal treatments</strong> focus on repairing skin damage, restoring
                        elasticity,
                        and enhancing natural radiance — helping you look younger, fresher, and more confident.
                    </p>
                    ...
                    <div class="row g-4">
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855;">
                                        <i class="fas fa-spa me-2"></i>Our Anti-Aging Solutions
                                    </h5>
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Collagen-boosting
                                            therapies</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>PRP & GFC skin
                                            rejuvenation</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Advanced
                                            mesotherapy & fillers</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Laser &
                                            light-based treatments</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Medical-grade
                                            skincare programs</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855;">
                                        <i class="fas fa-heart me-2"></i>Benefits of Age Reversal
                                    </h5>
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Reduces wrinkles &
                                            fine lines</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Improves skin
                                            tightness & elasticity</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Restores youthful
                                            glow & radiance</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Corrects uneven
                                            skin tone & texture</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Boosts long-term
                                            skin health</li>
                                    </ul>
                                </div>
                            </div>
