    ...
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/img/breadcumb/breadcumb-bg.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">Sun Protection</h2>
            ...
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-6 text-center position-relative">
                    <div class="image-stack position-relative d-inline-block p-3"
                        ...
                        <img src="{{ asset('purnam/hair-treatment1.jpg') }}" alt="Sun Protection Daily Skin Care"
                        ...
                        <img src="{{ asset('purnam/hair-treatment2.jpg') }}" alt="SPF Skin Care"
                ...
                <div class="col-lg-6">
                    ...
                    <h2 class="fw-bold mb-4"
                        ...
                        Sun Protection – Daily Skin Care
                    </h2>

                    <p class="mb-4 lead" style="color:#555; font-size:1.1rem; line-height:1.8;">
                        Protecting your skin from harmful <strong style="color:#a07855;">UV rays</strong> is one of the
                        most
                        important steps in skin care. Daily sun protection prevents premature aging, pigmentation, and
                        skin damage while maintaining an even, healthy complexion. Our expert-guided
                        <strong>Sun Protection Daily Skin Care</strong> routine ensures your skin stays youthful and
                        radiant.
                    </p>
                    ...
                    <div class="row g-4">
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855;">
                                        <i class="fas fa-sun me-2"></i>Sun Care Steps
                                    </h5>
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Daily SPF
                                            application (30+ or higher)</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Reapply sunscreen
                                            every 2–3 hours</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Use wide-brimmed
                                            hats & protective clothing</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Apply
                                            antioxidant-rich serums</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Choose
                                            non-comedogenic, lightweight SPF</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855;">
                                        <i class="fas fa-shield-alt me-2"></i>Benefits of Sun Protection
                                    </h5>
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Prevents premature
                                            wrinkles & fine lines</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Reduces risk of
                                            skin cancer</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Protects against
                                            pigmentation & dark spots</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Keeps skin tone
                                            even & radiant</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Maintains
                                            long-term skin health</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
