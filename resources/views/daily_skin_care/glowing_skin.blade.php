    ...
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/img/breadcumb/breadcumb-bg.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">Glowing Skin</h2>
            ...
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-6 text-center position-relative">
                    <div class="image-stack position-relative d-inline-block p-3"
                        ...
                        <img src="{{ asset('purnam/hair-treatment1.jpg') }}" alt="Glowing Skin Care"
                        ...
                        <img src="{{ asset('purnam/hair-treatment2.jpg') }}" alt="Radiant Skin Treatment"
                ...
                <div class="col-lg-6">
                    ...
                    <h2 class="fw-bold mb-4"
                        ...
                        Glowing Skin – Daily Skin Care
                    </h2>

                    <p class="mb-4 lead" style="color:#555; font-size:1.1rem; line-height:1.8;">
                        A natural glow reflects skin that is healthy, nourished, and well cared for.
                        Our <strong style="color:#a07855;">Glowing Skin Daily Skin Care</strong> routine is designed
                        to boost radiance, improve texture, and enhance luminosity through proper nourishment
                        and rejuvenation. This approach restores your skin’s vitality and gives you a lasting youthful
                        shine.
                    </p>
                    ...
                    <div class="row g-4">
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855;">
                                        <i class="fas fa-magic me-2"></i>Steps for Radiant Glow
                                    </h5>
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Gentle daily
                                            cleansing & exfoliation</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Vitamin C &
                                            antioxidant-rich serums</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Hydration with
                                            hyaluronic acid</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Regular
                                            brightening face masks</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Daily sun
                                            protection (SPF)</li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855;">
                                        <i class="fas fa-star me-2"></i>Benefits of Glowing Skin Care
                                    </h5>
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Restores natural
                                            radiance & shine</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Improves overall
                                            skin texture</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Reduces dullness &
                                            uneven tone</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Keeps skin soft,
                                            supple & youthful</li>
