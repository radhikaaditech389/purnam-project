    ...
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/img/breadcumb/breadcumb-bg.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">Skin Care Treatments</h2>
            ...
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-6 text-center position-relative">
                    <div class="image-stack position-relative d-inline-block p-3"
                        ...
                        <img src="{{ asset('purnam/hair-treatment1.jpg') }}" alt="Skin Care Treatments"
                        ...
                        <img src="{{ asset('purnam/hair-treatment2.jpg') }}" alt="Advanced Skin Care"
                ...
                <div class="col-lg-6">
                    <span class="text-uppercase fw-semibold mb-2 d-block"
                        ...
                        Complete Skin Wellness
                    </span>
                    <h2 class="fw-bold mb-4"
                        style="font-size:2.7rem; color:#333; letter-spacing:-1px; line-height:1.3;">
                        Skin Care Treatments – Healthy, Glowing & Ageless Skin
                    </h2>

                    <p class="mb-4 lead" style="color:#555; font-size:1.1rem; line-height:1.8;">
                        At <strong style="color:#a07855;">Purnam</strong>, our
                        <strong>Skin Care Treatments</strong> are designed to target every skin need — from hydration
                        and daily protection
                        to anti-aging therapies that reverse time. Our personalized solutions ensure you achieve
                        naturally radiant,
                    ...
                    <div class="row g-4">
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855;">
                                        <i class="fas fa-leaf me-2"></i>Daily Skin Care
                                    </h5>
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Hydration &
                                            Nourishment</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Purification &
                                            Detox Care</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Sun Protection &
                                            Repair</li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855;">
                                        <i class="fas fa-star me-2"></i>Advanced Treatments
                                    </h5>
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Repair &
                                            Rejuvenation</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Glowing Skin
                                            Therapies</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Age Reversal
                                            Solutions</li>
                                    </ul>
                                </div>
                            </div>
