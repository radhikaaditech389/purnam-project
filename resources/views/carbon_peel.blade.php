...
==============================-->
    ...
    Breadcumb
============================== -->
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/carbon_peeling_bg.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">About Carbon Peeling</h2>
                <div class="breadcumb-menu-wrapper">
                    <ul class="breadcumb-menu">
                        <li><a href="/">Home</a></li>
                        <li>About Carbon Peeling</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <!--==============================
Carbon Peeling Procedure Section
==============================-->
<section class="carbon-peel-section py-5 skin-section-bg">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 mb-4 mb-lg-0 position-relative">
                ...
                <div class="col-lg-12 position-relative mb-4">
                    <div class="image-wrapper position-relative">
                        <img src="{{ asset('purnam/carbon_peel.jpg') }}" alt="Carbon Peeling Before"
                ...
                <div class="col-lg-12 position-relative">
                    <div class="image-wrapper position-relative">
                        <img src="{{ asset('purnam/carbon_peel1.jpg') }}" alt="Carbon Peeling After"
            ...
            <div class="col-lg-6">
                ...
                <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                    <strong style="color:#c28565;">Carbon Peeling</strong> is a revolutionary laser treatment that uses a 
                    layer of liquid carbon to deeply cleanse pores, reduce acne, control oil, and leave your skin smooth, 
                    fresh, and glowing.
                </p>
                ...
                <div class="row g-4">
                        ...
                        <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                            <div class="card-body">
                                <h5 class="fw-bold mb-3" style="color:#c28565; font-size:1.4rem;">
                                    <i class="fas fa-burn me-2" style="color:#c28565;"></i>Deep Cleansing
                                </h5>
                                <p class="card-text" style="color:#666; line-height:1.7;">
                                    Carbon particles absorb impurities and laser energy blasts away dirt & oil from pores.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                            <div class="card-body">
                                ...
                                <p class="card-text" style="color:#666; line-height:1.7;">
                                    Stimulates collagen, evens skin tone, and reduces acne scars & pigmentation.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                            <div class="card-body">
                                <h5 class="fw-bold mb-3" style="color:#c28565; font-size:1.4rem;">
                                    <i class="fas fa-star me-2" style="color:#c28565;"></i>Benefits of Carbon Peeling
                                </h5>
                                <ul class="list-unstyled mb-0"
                                    style="font-size:0.95rem; color:#444; line-height:2;">
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Reduces acne & blackheads</li>
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Controls excess oil production</li>
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Minimizes enlarged pores</li>
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Evens out pigmentation & scars</li>
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Instant skin glow & smoothness</li>
                                </ul>
                            </div>
                        </div>
                    </div>
