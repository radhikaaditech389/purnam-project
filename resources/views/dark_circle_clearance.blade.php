...
============================== -->
 ...
 <!--==============================
Dark Circle Clearance Procedure Section
==============================-->
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                    ...
                    under-eye pigmentation, puffiness, and tired appearance — restoring a fresh, youthful, and
                    well-rested look.
                </p>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                            <div class="card-body">
                                ...
                                <p class="card-text" style="color:#666; line-height:1.7;">
                                    Improves blood circulation, reduces puffiness, and restores under-eye brightness.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                            <div class="card-body">
                                <h5 class="fw-bold mb-3" style="color:#c28565; font-size:1.4rem;">
                                    <i class="fas fa-star me-2" style="color:#c28565;"></i>Benefits of Dark Circle Clearance
                                </h5>
                                <ul class="list-unstyled mb-0"
                                    style="font-size:0.95rem; color:#444; line-height:2;">
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Reduces dark under-eye pigmentation</li>
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Minimizes puffiness & tired look</li>
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Improves skin texture under the eyes</li>
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Brightens & refreshes overall eye area</li>
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Safe & non-invasive procedure</li>
                                </ul>
                            </div>
                        </div>
                    </div>
