...
<body>
    ...
    {{-- Breadcumb --}}
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/treatment-images/fungal_infection_poster1.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">Bacterial, Viral, Fungal Infections</h2>
                <div class="breadcumb-menu-wrapper">
                    <ul class="breadcumb-menu">
                        <li><a href="index.html">Home</a></li>
                        <li>Bacterial, Viral, Fungal Infections</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0 position-relative">
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/treatment-images/fungal_infection.jpg') }}" alt="Dandruff Treatment"
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/treatment-images/fungal_infection2.jpg') }}" alt="Alopecia Treatment"
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4 lead" style="color:#555; font-size:1.1rem; line-height:1.8;">
                        <strong style="color:#a07855;">Skin and scalp infections</strong> can cause itching, redness,
                        and
                        visible damage if untreated. At <strong>Purnam</strong>, we combine expert diagnosis
                        with effective treatments to provide lasting relief and restore healthy skin & hair.
                    </p>
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855;">
                                        <i class="fas fa-exclamation-circle me-2"></i>Types
                                    </h5>
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Bacterial – Boils,
                                            Acne, Impetigo</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Viral – Warts,
                                            Herpes, Viral Rashes</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Fungal – Ringworm,
                                            Scalp Infections</li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Targeted medicines
                                            & therapies</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Advanced solutions
                                            for stubborn cases</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Hygiene &
                        ...
                        <div class="col-md-12">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Quick relief from
                                            itching & irritation</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Prevents spreading
                                            & complications</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Reduces recurrence
                                            risk</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Restores clear,
                                            healthy skin & scalp</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
