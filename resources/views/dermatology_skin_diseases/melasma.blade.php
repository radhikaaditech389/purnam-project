...
<body>
    ...
    {{-- Breadcumb --}}
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/treatment-images/melasma_poster1.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">Melasma</h2>
            ...
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0 position-relative">
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/treatment-images/melasma.jpg') }}" alt="Dandruff Treatment"
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/treatment-images/melasma2.jpeg') }}" alt="Alopecia Treatment"
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                        <strong style="color:#a07855;">Melasma</strong> is a skin pigmentation disorder that leads
                        to brown or grayish patches on the face, often due to sun exposure or hormonal changes.
                        At <strong>Purnam</strong>, we offer advanced treatments designed to reduce
                        pigmentation, restore skin radiance, and prevent future recurrence.
                    </p>
                    ...
                    <div class="row g-4">
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Excessive Sun
                                            Exposure</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Hormonal Changes
                                            (Pregnancy, Contraceptives)</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Genetic
                                            Predisposition</li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855; font-size:1.4rem;">
                                        <i class="fas fa-leaf me-2" style="color:#a07855;"></i>Our Treatments
                                    </h5>
                                    <ul class="list-unstyled mb-0"
                                        style="font-size:0.95rem; color:#444; line-height:2;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Chemical Peels &
                                            Laser Therapy</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Topical Lightening
                                            Agents</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Customized
                                            Skincare Regimens</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855; font-size:1.4rem;">
                                        <i class="fas fa-award me-2" style="color:#a07855;"></i>Benefits of Treatment
                                    </h5>
                                    <ul class="list-unstyled mb-0"
                                        style="font-size:0.95rem; color:#444; line-height:2;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Lightens dark
                                            patches effectively</li>
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Long-lasting
                                            results with maintenance care</li>
