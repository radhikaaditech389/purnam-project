...
<body>
    ...
    {{-- Breadcumb --}}
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/treatment-images/autoimmune_deases_poster1.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">Autoimmune Diseases</h2>
            ...
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0 position-relative">
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/treatment-images/autoimmune_deases.jpg') }}"
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/treatment-images/autoimmune_deases2.jpg') }}"
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                        <strong style="color:#a07855;">Autoimmune diseases</strong> occur when the immune
                        system attacks the body’s own tissues, leading to chronic inflammation, skin changes,
                        and systemic health issues. At <strong>Purnam</strong>, we provide advanced
                        care tailored to manage symptoms, improve quality of life, and control flare-ups.
                    </p>
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Persistent fatigue
                                            & weakness</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Skin rashes,
                                            patches, or lesions</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Joint pain &
                                            stiffness</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Unexplained hair
                                            loss (alopecia areata)</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Comprehensive
                                            diagnosis & autoimmune testing</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Personalized
                                            medication plans (steroids, biologics, immunosuppressants)</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Advanced therapies
                                            for skin & hair (phototherapy, PRP, mesotherapy)</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Lifestyle & diet
                                            modifications to reduce flare-ups</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        style="font-size:0.95rem; color:#444; line-height:2;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Controls
                                            inflammation & flare-ups</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Improves skin &
                                            hair condition</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Reduces long-term
                                            complications</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Enhances overall
                                            quality of life</li>
                                    </ul>
                                </div>
                            </div>
