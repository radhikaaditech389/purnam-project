...
<body>
    ...
    {{-- Breadcumb --}}
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/treatment-images/psoriasis_poster1.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">Psoriasis</h2>
            ...
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0 position-relative">
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/treatment-images/psoriasis.jpg') }}" alt="Dandruff Treatment"
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/treatment-images/psoriasis2.png') }}" alt="Alopecia Treatment"
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                        <strong style="color:#a07855;">Psoriasis</strong> is a chronic autoimmune condition
                        that accelerates skin cell growth, leading to thick, scaly patches that can be itchy,
                        painful, and emotionally distressing. At <strong>Purnam</strong>, we provide
                        advanced therapies to manage symptoms, reduce flare-ups, and restore skin comfort.
                    </p>
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Red, inflamed skin
                                            patches</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Thick
                                            silvery-white scales</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Itching, burning,
                                            or soreness</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>May affect scalp,
                                            nails, elbows, knees</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        style="font-size:0.95rem; color:#444; line-height:2;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Comprehensive skin
                                            & health evaluation</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Topical creams &
                                            medicated shampoos</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Light therapy &
                                            biologic treatments</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Dietary &
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Reduces itching,
                                            scaling, and irritation</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Slows down skin
                                            cell overgrowth</li>
