...
<body>
    ...
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/img/breadcumb/breadcumb-bg.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">Hair Transplant</h2>
    ...
    <section class="haircare-section py-5" style="background: linear-gradient(to right, #fefdfb, #fbeee7);">
        <div class="container">
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-6 text-center position-relative">
                    <div class="image-stack position-relative d-inline-block p-3"
                        ...
                        <img src="{{ asset('purnam/hair-treatment1.jpg') }}" alt="Hair Transplant"
                        ...
                        <img src="{{ asset('purnam/hair-treatment2.jpg') }}" alt="Hair Transplant Results"
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                        Our <strong style="color:#a07855;">Hair Transplant</strong> treatments restore your hairline
                        and confidence with safe, advanced techniques that ensure natural and permanent results.
                    </p>
                    ...
                    <div class="row g-4">
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855; font-size:1.4rem;">
                                        <i class="fas fa-user-md me-2" style="color:#a07855;"></i>FUE Method
                                    </h5>
                                    <p class="card-text" style="color:#666; line-height:1.7;">
                                        Minimally invasive, scar-free technique where individual hair follicles are
                                        transplanted for natural growth.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855; font-size:1.4rem;">
                                        <i class="fas fa-procedures me-2" style="color:#a07855;"></i>FUT Method
                                    </h5>
                                    <p class="card-text" style="color:#666; line-height:1.7;">
                                        Traditional strip method ideal for covering large bald areas with excellent
                                        long-term results.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Permanent &
                                            natural-looking results</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Boosts confidence
                                            & self-esteem</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Minimally invasive
                                            with fast recovery</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Customized
                                            hairline design</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Performed by
                                            expert surgeons</li>
                                    </ul>
                                </div>
                            </div>
