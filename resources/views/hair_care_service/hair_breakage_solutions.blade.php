...
<body>
    ...
    {{-- Breadcumb --}}
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/treatment-images/hair_breakage_poster1.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">Hair Breakage Solutions</h2>
                <div class="breadcumb-menu-wrapper">
                    <ul class="breadcumb-menu">
                        <li><a href="index.html">Home</a></li>
                        <li>Hair Breakage Solutions</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0 position-relative">
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/treatment-images/hair_breakage_solutions.jpg') }}"
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/treatment-images/hair_breakage_solutions1.jpg') }}" alt="Alopecia Treatment"
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                        Hair breakage makes your hair look dull, frizzy, and weak. At <strong
                            style="color:#a07855;">our clinic</strong>, we identify the root cause of breakage and
                        provide advanced repair therapies to restore shine, strength, and length naturally.
                    </p>
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background: #fff; border-radius: 10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Split ends
                                            & uneven growth</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Brittle,
                                            frizzy hair texture</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Hair
                                            snapping while combing</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Difficulty
                                            growing hair long</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background: #fff; border-radius: 10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        style="font-size:0.95rem; color:#444; line-height:2;">
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Heat
                                            styling & chemical treatments</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Poor diet &
                                            nutritional gaps</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>UV rays &
                                            pollution damage</li>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Keratin &
                                            Protein Repair Treatments</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>PRP &
                                            Mesotherapy for stronger roots</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Hydration &
                                            Nourishing Hair Masks</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Lifestyle &
                                            diet guidance</li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Experienced
                                            dermatologists & hair experts</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Latest hair
                                            repair therapies</li>
                                        ...
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Focus on
                                            both scalp & hair shaft health</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
