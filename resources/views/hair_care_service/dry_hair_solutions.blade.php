...
<body>
    ...
    {{-- Breadcumb --}}
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/treatment-images/dry_hair_poster1.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">Dry Hair Solutions</h2>
                <div class="breadcumb-menu-wrapper">
                    <ul class="breadcumb-menu">
                        <li><a href="index.html">Home</a></li>
                        <li>Dry Hair Solutions</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0 position-relative">
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/treatment-images/dry_hair.jpg') }}" alt="Dandruff Treatment"
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/treatment-images/dry_hair2.jpg') }}" alt="Alopecia Treatment"
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                        Dry, rough, and brittle hair can be difficult to manage. At <strong style="color:#a07855;">our
                            clinic</strong>, we provide advanced hydration therapies that deeply nourish and restore
                        softness, shine, and smoothness to your hair.
                    </p>
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background: #fff; border-radius: 10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Rough &
                                            brittle texture</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Frizz &
                                            split ends</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Lifeless
                                            appearance</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Hard to
                                            style & manage</li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Heat
                                            styling & chemical use</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Lack of
                                            natural scalp oils</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Sun
                                            exposure & pollution</li>
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>Poor
                                            nutrition & dehydration</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0"
                                        ...
                                        <li><i class="fas fa-check-circle me-2"
                                                style="color:#a07855;"></i>Moisture-Lock Therapy</li>
                                        ...
                                        <li><i class="fas fa-check-circle me-2" style="color:#a07855;"></i>PRP &
                                            Mesotherapy</li>
                                        <li><i class="fas fa-check-circle me-2"
                                                style="color:#a07855;"></i>Hydration-focused Hair Spa</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
