        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <p class="mb-4 lead" style="color:#555; font-size:1.15rem; line-height:1.8;">
                    <strong style="color:#c28565;">PRP Therapy</strong> uses the power of your own blood’s platelets to
                    stimulate healing and rejuvenation. The concentrated plasma is injected or applied to promote collagen
                        ...
                        <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                            <div class="card-body">
                                ...
                                <p class="card-text" style="color:#666; line-height:1.7;">
                                    Uses your body’s own platelets to repair tissues and stimulate collagen naturally.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                            <div class="card-body">
                                ...
                                <p class="card-text" style="color:#666; line-height:1.7;">
                                    Improves skin tone, reduces fine lines, and restores youthful glow without chemicals.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled mb-0"
                                    ...
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Minimizes wrinkles & fine lines</li>
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Safe & non-surgical treatment</li>
                                    <li><i class="fas fa-check me-2" style="color:#c28565;"></i>Boosts overall skin texture & glow</li>
                                </ul>
                            </div>
                        </div>
                    </div>
