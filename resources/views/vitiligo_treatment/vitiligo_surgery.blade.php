            ...
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-6 text-center position-relative">
                    <div class="image-stack position-relative d-inline-block p-3"
                        ...
                        <img src="{{ asset('purnam/hair-treatment2.jpg') }}" alt="Skin Grafting for Vitiligo"
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4 lead" style="color:#555; font-size:1.1rem; line-height:1.8;">
                        <strong>Vitiligo Surgery</strong> is a specialized procedure recommended for patients with
                        stable vitiligo
                        who do not respond to medical therapies. Surgical techniques like <strong>skin grafting</strong>
                        and
                        <strong>melanocyte transfer</strong> restore natural pigmentation by transplanting healthy skin
                        or pigment cells
                        into depigmented patches, resulting in long-lasting, natural-looking results.
                    </p>
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855;">
                                        <i class="fas fa-user-md me-2"></i>Surgical Techniques
                                    </h5>
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Split-Thickness
                                            Skin Grafting</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Suction Blister
                                            Grafting</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Punch Grafting
                                        </li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Melanocyte
                                            Transfer Surgery</li>
                                    </ul>
                                </div>
                            </div>
