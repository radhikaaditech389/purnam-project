    ...
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/img/breadcumb/breadcumb-bg.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">Whole Body Photo Therapy Unit</h2>
                <div class="breadcumb-menu-wrapper">
                    <ul class="breadcumb-menu">
                        <li><a href="index.html">Home</a></li>
                        <li>Whole Body Photo Therapy Unit</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-6 text-center position-relative">
                    <div class="image-stack position-relative d-inline-block p-3"
                        ...
                        <img src="{{ asset('purnam/hair-treatment1.jpg') }}" alt="Whole Body Phototherapy Unit"
                        ...
                        <img src="{{ asset('purnam/hair-treatment2.jpg') }}" alt="Phototherapy Treatment"
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4 lead" style="color:#555; font-size:1.1rem; line-height:1.8;">
                        Our <strong>Whole Body Phototherapy Unit</strong> delivers safe, controlled doses of
                        <strong>Narrowband UVB light</strong> to treat extensive skin conditions. It is ideal for
                        patients with widespread
                        <strong>psoriasis, vitiligo, eczema, and other autoimmune skin disorders</strong>.
                        The therapy reduces inflammation, stimulates repigmentation, and improves overall skin health —
                        all in a non-invasive, painless manner.
                    </p>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Vitiligo
                                            (widespread)</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Psoriasis</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Eczema</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Lichen Planus</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Chronic Itching
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Covers the entire
                                            body uniformly</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Safe, controlled
                                            UVB dosage</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Effective for
                                            widespread conditions</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Painless &
                                            non-invasive</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Proven long-term
                                            results</li>
                                    </ul>
                                </div>
                            </div>
