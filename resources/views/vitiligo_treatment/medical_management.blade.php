...
<body>
    ...
    {{-- Breadcumb --}}
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/treatment-images/vitiligo_surgery_poster1.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">Medical Management</h2>
    ...
    <section class="haircare-section py-5" style="background: linear-gradient(to right, #fdfaf6, #f1f9ff);">
        <div class="container">
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0 position-relative">
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/treatment-images/vitiligo.jpg') }}" alt="Dandruff Treatment"
                    ...
                    <div class="col-lg-12 position-relative">
                        <div class="image-wrapper position-relative">
                            <img src="{{ asset('purnam/treatment-images/vitiligo_treatment.jpg') }}"
                ...
                <div class="col-lg-6">
                    <span class="text-uppercase fw-semibold mb-2 d-block"
                        ...
                        Specialized Skin Solutions
                    </span>
                    <h2 class="fw-bold mb-4"
                        style="font-size:2.7rem; color:#333; letter-spacing:-1px; line-height:1.3;">
                        Vitiligo Treatment – Medical Management
                    </h2>

                    <p class="mb-4 lead" style="color:#555; font-size:1.1rem; line-height:1.8;">
                        <strong style="color:#a07855;">Vitiligo</strong> is a skin condition that causes loss of skin
                        color in patches.
                        At <strong>Purnam</strong>, we use advanced medical therapies and light treatments
                        to control the spread and restore skin pigmentation, improving both appearance and confidence.
                    </p>
                    ...
                    <div class="row g-4">
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855;">
                                        <i class="fas fa-pills me-2"></i>Medical Options
                                    </h5>
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Topical creams &
                                            ointments</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Oral medications
                                        </li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Vitamin &
                                            antioxidant support</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    <h5 class="fw-bold mb-3" style="color:#a07855;">
                                        <i class="fas fa-lightbulb me-2"></i>Advanced Therapies
                                    </h5>
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Phototherapy
                                            (NB-UVB, Excimer)</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Targeted
                                            repigmentation methods</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Lifestyle &
                                            psychological support</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Slows or stops
                                            spread of patches</li>
