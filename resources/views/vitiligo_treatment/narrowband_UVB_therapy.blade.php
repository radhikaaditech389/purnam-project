    ...
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('purnam/img/breadcumb/breadcumb-bg.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h2 class="breadcumb-title">Narrowband UVB Therapy</h2>
                <div class="breadcumb-menu-wrapper">
                    <ul class="breadcumb-menu">
                        <li><a href="index.html">Home</a></li>
                        <li>Narrowband UVB Therapy</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-6 text-center position-relative">
                    <div class="image-stack position-relative d-inline-block p-3"
                        ...
                        <img src="{{ asset('purnam/hair-treatment1.jpg') }}" alt="Narrowband UVB Machine"
                        ...
                        <img src="{{ asset('purnam/hair-treatment2.jpg') }}" alt="NB-UVB Therapy"
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4 lead" style="color:#555; font-size:1.1rem; line-height:1.8;">
                        <strong>Narrowband UVB (NB-UVB) therapy</strong> is a proven light-based treatment
                        that helps manage skin conditions such as <strong>vitiligo, psoriasis, eczema, and lichen
                            planus</strong>.
                        It works by reducing inflammation, stimulating pigment cells, and restoring skin balance — all
                        without
                        the side effects of strong medications.
                    </p>
                            ...
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Vitiligo</li>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background:#fff; border-radius:10px;">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0" style="color:#444; line-height:1.8;">
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Non-invasive &
                                            painless</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Safe for long-term
                                            use</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Reduces
                                            inflammation</li>
                                        <li><i class="fas fa-check me-2" style="color:#a07855;"></i>Stimulates
                                            pigmentation</li>
